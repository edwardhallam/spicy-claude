...
export type PermissionMode = "default" | "plan" | "acceptEdits" | "dangerous";
...
export function fromSDKPermissionMode(
  ...
  // Map "bypassPermissions" SDK mode to "dangerous" UI mode
  return sdkMode === "bypassPermissions" ? "dangerous" : sdkMode;
}
